...
@section('header')
    ...
    <style>
        ...
        .card-header {
            background-color: #31304D; /* Warna Hijau */
            padding: 20px;
        ...
        .btn-primary {
            background-color: #574f7d; /* Warna Hijau */
            border: none;
            border-radius: 5px;
            padding: 10px;
            width: 100%;
        ...
        .btn-primary:hover {
            background-color: #95adbe; /* Warna Hijau yang sedikit lebih gelap */
        }
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-footer">
                <a href="{{ route('register') }}" class="link-underline link-underline-opacity-0">
                    <p class="text-center" style="color: #503a65;"> <!-- Warna Hijau -->
